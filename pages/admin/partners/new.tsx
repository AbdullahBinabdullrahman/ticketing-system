...
import { type CreatePartnerWithUserInput } from "../../../schemas/partners";
...
export default function NewPartnerPage() {
  ...
  const onSubmit = async (data: CreatePartnerWithUserInput) => {
    try {
      ...
      //         "contactEmail": "a.maher.ba@hotmail.com",
      //         "contactPhone": "966566723503",
      //         "createdAt": "2025-11-12T13:05:53.353Z",
      //         "updatedAt": "2025-11-12T13:05:53.353Z",
      //         "branchesCount": 0,
      //         "categoriesCount": 0,
      //         "requestsCount": 0,
      ...
      //         "averageRating": 0
      //     },
      //     "timestamp": "2025-11-12T13:05:54.447Z"
      // }
        ...
        toast.success(
          <div>
            ...
            <p className="text-xs mt-1">
              {t("users.email")}: {response.data.data.contactEmail}
            </p>
          </div>,
      ...
      router.push(`/admin/partners/${response.data.data.id}`);
    } catch (error: unknown) {
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-6">
              {/* Preview Card */}
              <BlurFade delay={0.2}>
                <div className=" from-primary-50 to-primary-100 dark:from-primary-900/20 dark:to-primary-800/20 rounded-lg shadow-sm border border-primary-200 dark:border-primary-700 p-6 sticky top-6">
